...
class WeeklyForecastList extends StatelessWidget {
          ...
          (BuildContext context, int index) {
            ...
            child: Row(
              children: [
                ...
                weatherColumn(dailyForecast, currentDate, textTheme),
                weatherTemperature(dailyForecast, textTheme),
              ],
            ),
          );
        },
  ...
  Widget weatherTemperature(DailyForecast dailyForecast, TextTheme textTheme) {
    return Padding(
  ...
  Widget weatherColumn(DailyForecast dailyForecast, DateTime currentDate, TextTheme textTheme) {
    return Expanded(
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Column(
  ...
  Widget weatherImage(DailyForecast dailyForecast, DateTime currentDate, TextTheme textTheme) {
    return SizedBox(
                width: 200,
                height: 200,
                child: Stack(
